"""
In-memory storage for SOA Academic System
Simple data structures to replace database persistence
"""
from datetime import datetime
from typing import Dict, List, Optional, Any

class InMemoryStorage:
    """Base class for in-memory storage"""
    ...
    def find_by_field(self, field: str, value: Any) -> Optional[Dict]:
        """Find first item by field value"""
...
class CoursesStorage(InMemoryStorage):
    ...
    def update_available_slots(self, course_code: str, change: int) -> bool:
        """Update available slots for a course"""
...
class EnrollmentsStorage(InMemoryStorage):
    ...
    def find_active_enrollment(self, student_id: int, course_code: str) -> Optional[Dict]:
        """Find active enrollment for student and course"""
...
def recalculate_course_slots():
    """Recalculate available slots for all courses based on active enrollments"""
    try:
        # Get all courses
        ...
        # Update available slots for each course
        for course in all_courses:
            ...
            # Update the course data directly
...
def initialize_sample_data():
    ...
    try:
        ...
        # Sample courses (al menos 2)
        courses_storage.create_course("IS101", "Programación I", 3, "Dr. Ana María Smith", "Lun-Mie-Vie 8:00-10:00", 25)
        courses_storage.create_course("IS102", "Base de Datos I", 4, "Dra. Carmen Johnson", "Mar-Jue 10:00-12:00", 30)
        courses_storage.create_course("IS103", "Algoritmos y Estructuras de Datos", 3, "Dr. Roberto Brown", "Lun-Mie 14:00-16:00", 20)
        courses_storage.create_course("MATH101", "Cálculo Diferencial", 4, "Dra. Patricia Morales", "Mar-Jue 8:00-10:00", 35)
        courses_storage.create_course("PHYS101", "Física I", 3, "Dr. Luis Hernández", "Lun-Mie-Vie 10:00-11:30", 30)
        
        # Sample enrollments (al menos 2) - también actualizar cupos de cursos
        enrollments_storage.create_enrollment(1, "IS101")  # Juan en Programación I
        courses_storage.update_available_slots("IS101", -1)
        
        enrollments_storage.create_enrollment(2, "IS102")  # María en Base de Datos I
        courses_storage.update_available_slots("IS102", -1)
        
        enrollments_storage.create_enrollment(3, "MATH101")  # Carlos en Cálculo
        courses_storage.update_available_slots("MATH101", -1)
        
        enrollments_storage.create_enrollment(1, "PHYS101")  # Juan también en Física I
    ...
    # Always recalculate available slots based on existing enrollments
